...
// Normalize allCountries (supports different shapes)
...
export default function Profile() {
  ...
  // Prevent double navigation (React StrictMode + re-renders)
    ...
    (async () => {
      try {
        ...
        if (snap.exists()) {
          ...
          // ✅ Redirect ONLY if profileComplete true
          ...
          batch.push(
            setDoc(
              contactRef,
              {
                ...
                isPinned: false, // Always unpinned by default
  ...
  // Dark loading screen (no blinking loops)
