  ...
  return (
    <>
      <div>
        ...
        {error && (
          <div
            className="bg-red text-red-700 p-4
         rounded-md mb-6 flex items-center "
          >
        ...
        {loading ? (
          ...
          <div
            className="grid grid-cols-1 md:grid-colos-2
          lg:grid-cols-3"
          >
            {notes.map((note) => (
          ...
          >
            ...
            <h3 className="text-lg font-medium
             text-gray-900 mb-1">Not notes yet</h3>
            <p className="text-gray-600 mb-1">Create your first page to get started</p>
          </div>
        )}
      </div>
    </>
