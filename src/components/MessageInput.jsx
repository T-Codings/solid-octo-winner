...
export default function MessageInput({ onSend, disabled, selectedContact, currentUser, replyMsg, onCancelReply }) {
  const emojiList = [
    "😀", "😁", "😂", "🤣", "😊", "😍", "😎", "😢", "😡", "👍", "🙏", "🎉", "❤️", "🔥", "🥳",
    "😃", "😄", "😅", "😆", "😉", "😋", "😜", "🤪", "🤩", "🥰", "😘", "😗", "😙", "😚", "😇",
    "🤗", "🤔", "🤨", "😐", "😑", "😶", "🙄", "😏", "😣", "😥", "😮", "🤐", "😯", "😪", "😫",
  ...
  return (
    <div className="flex flex-col">
      {replyMsg && (
        <div className="flex items-center bg-sky-50 border-l-4 border-sky-400 px-3 py-2 text-xs text-sky-700">
          <span className="font-semibold mr-2">Replying to:</span> {replyMsg.text}
          <button className="ml-auto text-sky-500 hover:text-sky-700" onClick={onCancelReply} title="Cancel reply">&times;</button>
        </div>
      )}
